...
function FakePod({ gpuModel, hourlyRate, vCPU, ramGB }: FakePodProps) {
...
const Subheader: React.FC<SubheaderProps> = ({ gpuModel, hourlyRate, vCPU, ramGB }) => {
  return (
    <HeroWrapper>
      <ContentWrapper>
        <Typography 
        ...
        >
          GPU Computing Made So Simple, It Feels Like Magic.
          <Box
            component="span"
            sx={{
