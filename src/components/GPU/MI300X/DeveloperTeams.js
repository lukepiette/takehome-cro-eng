                ...
                <Table size="small">
                  <TableBody>
                    ...
                    <TableRow>
                      ...
                      <TableCell align="right">
                        <Typography fontSize={14}>{data.info.FP32}</Typography>
                      </TableCell>
                      <TableCell align="right">
                        <Typography fontSize={14}>{data.comparedTo.FP32}</Typography>
                      </TableCell>
                    </TableRow>
                    ...
                    <TableRow>
                      ...
                      <TableCell align="right">
                        <Typography fontSize={14}>{data.info.FP8}</Typography>
                      </TableCell>
                      <TableCell align="right">
                        <Typography fontSize={14}>{data.comparedTo.FP8}</Typography>
                      </TableCell>
                    </TableRow>
