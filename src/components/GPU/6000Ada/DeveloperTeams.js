    ...
    >
      <Stack>
        ...
        <Stack direction={{xs:"column", sm:"column", md:"row"}} spacing={{ xs: 0, sm: 0, md: 4, lg: 6 }}>
          <Stack direction="column" width={{sm:525, md:450, lg: 525}} justifyContent={{ xs: "center", md: "start" }}>
          ...
          <Stack direction="column" width={{sm:525, md:450, lg: 525}} justifyContent={{ xs: "center", md: "start" }}>
            ...
            <Typography fontSize={15} variant="subtitle1">
              Spin up hundreds of {data.name} GPUs across {data.community.regions} regions.
            </Typography>
