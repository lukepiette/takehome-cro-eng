    ...
    >
      <Stack  >
        ...
        <Stack direction={{xs:"column",sm:"column", md:"row"}} spacing={{ xs: 0, sm: 0, md: 0, lg: 0 }}>
          <Stack width={{sm:650}} direction="column" mt={2} justifyContent={{ xs: "center", md: "start" }}>
              ...
              <Table size="medium">
                <TableBody>
                  ...
                  <TableRow>
                    ...
                    <TableCell align="right">
                      <Typography fontSize={14}>{data.info.price3Month}</Typography>
                    </TableCell>
                  </TableRow>
                  ...
                  <TableRow>
                    ...
                    <TableCell align="right">
                      <Typography fontSize={14}>{data.info.price6Month}</Typography>
                    </TableCell>
                  </TableRow>
                  ...
                  <TableRow>
                    ...
                    <TableCell align="right">
                      <Typography fontSize={14}>{data.info.price12Month}</Typography>
                    </TableCell>
                  </TableRow>
                  ...
                  <TableRow>
                    ...
                    <TableCell align="right">
                      <Typography fontSize={14}>{data.info.price36Month}</Typography>
                    </TableCell>
                  </TableRow>
                </TableBody>
              </Table>
