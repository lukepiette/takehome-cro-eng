    ...
    <LogosContainer>
      ...
      <ContentFrame>
        <TextContainer>
          ...
          <Text variant="body2">
          Eengineers from the world{"'"}s leading companies <span style={{ color: '#FFFFFF' }}>slash millions in costs</span> every year by choosing RunPod for their critical AI workloads.
          </Text>
        </TextContainer>
        <LogosWrapper>
