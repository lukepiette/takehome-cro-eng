  ...
  return (
    <QuoteWrapper>
      <TitleContent>
        ...
        <QuoteContent>
          <QuoteTitle>{"\""}RunPod{"'"}s ability to scale on-demand is unmatched.{"\""}
          </QuoteTitle>
          <QuoteText>
            {isMobile
              ? `${"\""}Whether I need 10 GPUs or 1000, they're available instantly. This level of flexibility has transformed how I approach large-scale workloads.${"\""}`
