	...
	return (
		<Box
			...
			<Box
				...
				<Box
					...
					<Typography
						...
						30+ GPU models at your fingertips. Whether you{"'"}re
						fine-tuning or going full Skynet, we{"'"}ve got the
						silicon to match.
						<Box
							component="span"
							sx={{ display: { xs: "none", sm: "inline" } }}>
							{" "}
							Spread across 31 regions, our global network puts
							teraflops in your backyard. And our support? They
							don{"'"}t just read from a script—they read your
							mind.
						</Box>
					</Typography>
				</Box>
			...
			<TableContainer
				...
				<Table size="small">
					{" "}
					{/* Added size="small" to make the table more compact */}
					<TableHead>
						<TableRow>
