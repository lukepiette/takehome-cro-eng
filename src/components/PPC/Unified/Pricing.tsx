...
const Pricing = () => {
	...
	const sortedTableData = tableData.sort(
		(a, b) => b.communityPrice - a.communityPrice
	);
			...
			<HeroWrapper>
				<ContentWrapper>
					...
					<Typography
						...
						Slash costs, not performance. Our transparent, on-demand
						pricing means you pay only for what you use.
					</Typography>
				</ContentWrapper>
			</HeroWrapper>
