		...
		<HeroWrapper>
			<ContentWrapper>
				...
				<Typography
					...
					Getting started is as easy as flipping a switch. No
					labyrinthine menus, no guessing games—just simple,
					straightforward access to the GPUs you need, when you need
					them.
					<Box
						component="span"
						sx={{
						...
						{" "}
						Our platform is designed for speed and simplicity, so
						you can spin up resources in seconds, not hours.
					</Box>
				</Typography>
				<FakePod />
			</ContentWrapper>
