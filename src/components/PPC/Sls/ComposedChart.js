    ...
    <ResponsiveContainer width="100%" height="100%">
      <BarChart
        ...
        margin={{
          ...
          right: Boolean(labelDataKey) ? 20 : 30,
          left: Boolean(labelDataKey) ? 20 : 40,
          bottom: -30,
        }}
        syncId={syncId}
      >
...
const TickY = ({ x, y, payload, tickSuffix }) => (
  <g transform={`translate(${x},${y})`}>
    <text x={-30} y={0} dy={4} fill="#666" fontSize="12px" textAnchor="end">
      {payload.value}
      {tickSuffix}
    </text>
  </g>
          ...
          <Stack>
            {payload.map((v, i) => (
              ...
              >
                ...
                {parseInt(
                  valueSuffix ? v.payload[`${v.dataKey}_value`] : v.value
