...
const Comparison = () => {
  ...
  const comparisonData = [
    { feature: 'Unique GPU models', runpod: '32', aws: '11' },
    { feature: 'Global regions', runpod: '31', aws: '26' },
    { feature: 'Free 24/7 Support', runpod: true, aws: false },
    { feature: 'Delightful Developer Experience', runpod: true, aws: false },
    { feature: 'Network storage', runpod: true, aws: true },
    { feature: 'Enterprise-Grade Machine Reliability', runpod: true, aws: true },
  ];
        ...
        <Table>
          <TableHead>
            <TableRow>
              ...
              <StyledTableCell sx={{ textTransform: 'none' }} align="center">RunPod</StyledTableCell>
              <StyledTableCell sx={{ textTransform: 'none', color: 'rgba(249, 250, 251, 0.48)' }} align="center">AWS</StyledTableCell>
            </TableRow>
          </TableHead>
          <TableBody>
              ...
              <StyledTableRow key={row.feature}>
                ...
                <StyledTableCell align="center">
                  {typeof row.runpod === 'boolean' ? 
                    (row.runpod ? <CheckIcon sx={{ color: '#4CAF50' }} /> : <CloseIcon color="error" />) : 
                    row.runpod}
                </StyledTableCell>
                <StyledTableCell align="center" sx={{ color: 'rgba(249, 250, 251, 0.48)' }}>
                  {typeof row.aws === 'boolean' ? 
                    (row.aws ? <CheckIcon sx={{ color: '#4CAF50' }} /> : <CloseIcon color="error" />) : 
                    row.aws}
                </StyledTableCell>
              </StyledTableRow>
            ))}
