...
export default function FooterGetStarted() {
  ...
  return (
    <Stack alignItems="center" position="relative" mt={isMobile ? 5 : 20} pb={isMobile ? 12 : 24} width="100%">
      <Box
        bottom={0}
      ...
      >
        <RunPodIcon style={{ color: "#fff", height: isMobile ? 56 : 75, width: isMobile ? 56 : 75 }} />
      </Stack>
      <Stack mt={2} direction="row" flexWrap="wrap" justifyContent="center">
        <Typography
      ...
      <ButtonLink
        ...
        sx={{
          ...
          justifyContent: 'center',
          alignItems: 'center',
          padding: isMobile ? '32px 16px' : '64px 33.75px 64px 50.625px',
          gap: '4px',
          isolation: 'isolate',
          width: isMobile ? '90%' : '571px',
          height: isMobile ? 'auto' : '207px',
          background: 'linear-gradient(180deg, rgba(187, 77, 255, 0) 0%, rgba(93, 41, 240, 0.25) 100%), radial-gradient(85.83% 85.83% at 50% 14.17%, #000000 0%, #000000 59.12%, #000000 85.94%)',
          boxShadow: 'inset 0px 8px 2.40622px #B0CBFF, inset 0px 24px 24px #5D29F0',
          borderRadius: '9900px',
          mt: 6,
        }}
      >
        ...
        <KeyboardArrowRightIcon sx={{ fontSize: isMobile ? 28 : 42.19, ml: 1, color: '#F9FAFB' }} />
      </ButtonLink>
    </Stack>
  );
}
