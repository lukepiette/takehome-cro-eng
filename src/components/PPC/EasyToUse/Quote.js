  ...
  return (
    <QuoteWrapper>
      <TitleContent>
        ...
        <QuoteContent>
          <QuoteTitle>{"\""}RunPod is my go-to platform when I need to quickly iterate on models or test ideas{"\""}
          </QuoteTitle>
          <QuoteText>
            {isMobile
              ? `${"\""}In my work, I regularly have to interact with robust cloud platforms like AWS, GCP, and Azure. They're powerful, but when I need to quickly iterate on models or test ideas, RunPod is my go-to platform.${"\""}`
              : `${"\""}In my work, I regularly have to interact with robust cloud platforms like AWS, GCP, and Azure. They're powerful, but when I need to quickly iterate on models or test ideas, RunPod is my go-to platform. Its become an indispensable tool in my arsenal, significantly accelerating my development cycle.${"\""}`
            }
          </QuoteText>
        </QuoteContent>
      </TitleContent>
