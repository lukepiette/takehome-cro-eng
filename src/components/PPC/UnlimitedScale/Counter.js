...
const Ellipse1592 = styled('div')(({ theme }) => ({
  ...
  left: '50%',
  top: "60%",
  background: 'radial-gradient(85.83% 85.83% at 50% 14.17%, rgba(0, 0, 0, 0) 0%, rgba(0, 0, 0, 0) 59.12%, #000000 85.94%)',
  boxShadow: 'inset 0px -3.44038px 1.2379px #B0CBFF, inset 0px -22.3211px 22.3211px #5D29F0',
    ...
    <Stack alignItems="center" position="relative" width="100%">
      ...
      <Stack alignItems="center"  justifyContent="center">
        ...
        >
          ...
          >
            requests since launch & <span style={{ color: '#FFFFFF' }}>160k+ developers</span> worldwide
          </Typography>
        </Stack>
