import { Box, Stack, Link, Typography, useTheme, Divider, Container } from "@mui/material"
...
const TableOfContents = () => {
  return (
    <Stack pt={10}>
      ...
      <ol>
        <li style={{ fontSize: 18 }}><Link href="#introduction">Introduction</Link></li>
        <li style={{ fontSize: 18 }}><Link href="#executive-summary">Executive Summary</Link></li>
        <li style={{ fontSize: 18 }}><Link href="#cloud-orchestrator-platform">RunPod’s Cloud Orchestrator Platform</Link></li>
        <li style={{ fontSize: 18 }}><Link href="#compliance-overview">Compliance Overview</Link></li>
        <li style={{ fontSize: 18 }}><Link href="#data-center-partners">Data Center Partners</Link></li>
        <li style={{ fontSize: 18 }}><Link href="#faqs">FAQs</Link></li>
      </ol>   
    </Stack>
  );
};
...
export default function Careers() {
  ...
  return (
    ...
    <Stack alignItems={"center"} mb={20} mt={8} position="relative">
      ...
      <Stack alignItems="left" sx={{ maxWidth: 1100}} padding={{xs:5, md:0}}>
        <StickyFooterWrapper>
          ...
          <Container maxWidth="lg">
            <Stack direction={{xs:"column", sm:"row"}} justifyContent="center" alignItems="center" spacing={2}>
              ...
              <StartButton title={"Book a call"} to={"https://meetings.runpod.io/meetings/runpod/enterprise-compliance-and-security-chat"} />
            </Stack>
          </Container>
        </StickyFooterWrapper>
        ...
        <Typography variant="h1" mb={4}>Compliance at RunPod</Typography>
        ...
        <Typography align="left" mb={4} pt={10} variant="h1" id="introduction">
          1. Introduction
        </Typography>
        <Typography align="left" fontSize={18}>
        ...
        <Stack>
            <ol>
              <li style={{ fontSize: 18 }}>
                To offer an overview of our security protocols, measures, and strategies, ensuring our clientele and stakeholders understand the lengths we go to in safeguarding their data and workloads.
              </li>
              <li style={{ fontSize: 18, paddingTop: 20 }}>
                To present an overview of the compliance certifications and standards upheld by our network of data centers. Given the varied compliance levels across our partner data centers, this document aims to shed light on what our clients can expect, irrespective of where their data resides.
              </li>
            </ol>
          </Stack>
        ...
        <Typography align="left" fontSize={18}>
          ...
          <Stack>
            <ul>
              <li style={{ fontSize: 18 }}>
                <b>Proactive Defense:</b> Our systems are designed not just to respond, but to preempt. Regular vulnerability assessments, penetration testing, and continuous monitoring ensure we stay ahead of potential threats.
              </li>
              <li style={{ fontSize: 18, paddingTop: 20 }}>
                <b>End-to-end Encryption:</b> Data in transit and at rest is encrypted using industry-leading protocols. This ensures that your AI workloads and associated data remain confidential and tamper-proof.
              </li>
              <li style={{ fontSize: 18, paddingTop: 20 }}>
                <b>Operational Integrity:</b> Our staff undergo rigorous security training, and access to client data is governed by strict role-based controls. Furthermore, disaster recovery plans and incident response protocols are perpetually at the ready, ensuring business continuity and data integrity.
              </li>
            </ul>
          </Stack>
        ...
        <Typography align="left" mb={4} pt={10} variant="h1" id="cloud-orchestrator-platform">
        ...
        <Typography align="left" fontSize={18}>
          ...
          <Stack>
            <ul>
              <li style={{ fontSize: 18 }}>
                <b>Intelligent Resource Allocation:</b> At the heart of RunPod is an advanced allocation algorithm that ensures optimal resource distribution. By continually analyzing workloads, we prevent system overloads and potential breaches from exploitation of resource gaps.
              </li>
              <li style={{ fontSize: 18, paddingTop: 20 }}>
                <b>Real-time Monitoring:</b> We vigilantly monitor hardware performance and data integrity. This continuous oversight allows us to instantly detect anomalies, ensuring both the security and reliability of the services we offer.
              </li>
              <li style={{ fontSize: 18, paddingTop: 20 }}>
                <b>End-to-end Encryption:</b> Data handling, in terms of physical storage, is under the purview of our data center partners. That said, we have implemented robust encryption protocols to ensure that all data, whether in transit between our platform and the data centers, or during processing, is kept confidential and secure.
              </li>
              <li style={{ fontSize: 18, paddingTop: 20 }}>
                <b>Automated Workload Management:</b> Our platform can automatically scale and manage workloads, reducing human intervention and, by extension, the potential for human-induced vulnerabilities.
              </li>
            </ul>
          </Stack>
        </Typography>
        ...
        <Typography align="left" fontSize={18}>
          ...
          <Stack>
            <ol>
              <li style={{ fontSize: 18 }}>
                <b>Physical Security:</b> Measures like surveillance, access controls, and onsite security personnel are managed directly by our data center partners. They have the expertise and infrastructure to ensure the physical sanctity of the hardware.
              </li>
              <li style={{ fontSize: 18, paddingTop: 20 }}>
                <b>Compliance Adherence:</b> Different data centers might have varying compliance certifications. While we ensure that all our partners uphold stringent standards, the specifics of each compliance are directly managed by the respective data center.
              </li>
              <li style={{ fontSize: 18, paddingTop: 20 }}>
                <b>Data Handling:</b> While we encrypt and secure data during transit and processing, the physical storage and its associated security protocols are under the purview of the data centers.
              </li>
            </ol>
          </Stack>
          ...
          <Stack >
            <ol>
              <li style={{ fontSize: 18 }}>
                ...
                <ul>
                  <li>Location Filtering: Choose data center locations that align with your specific requirements, ensuring both performance optimization and compliance adherence.</li>
                  <li>Enterprise Discounts: Reserve Secure Cloud GPUs and avail enterprise-grade discounts, optimizing both performance and cost.</li>
                  <li>Tailored Solutions: We understand that one size doesn&apos;t fit all. Contact us for a deeper dive into how the Secure Cloud can be tailored to your unique needs.</li>
                </ul>
              </li>
              <li style={{ fontSize: 18, paddingTop: 20 }}>
                <b>Serverless</b><br></br>
                ...
                <ul>
                  <li>Autoscaling: Forget about resource management. Our endpoints scale seamlessly based on your workload demands.</li>
                  <li>Multi-data Center Resources: By default, our serverless endpoints utilize resources from various data centers, ensuring optimal performance.</li>
                  <li>Compliance-Driven Scaling: Have stringent compliance requirements like SOC2? We&apos;ve got you covered. Your endpoints can be isolated to run exclusively on data centers that tick every box on your compliance checklist.</li>
                </ul>
              </li>
              <li style={{ fontSize: 18, paddingTop: 20 }}>
                <b>Bare Metal</b><br></br>
                ...
                <ul>
                  <li>Off-Platform Servers: Direct access to the raw power of off-platform servers for tasks that need it.</li>
                  <li>Diverse Workloads: Whether it&apos;s large-scale training, k8s, or VMs, our Bare Metal supports it.</li>
                  <li>Container Exclusivity: Please note that our Secure Cloud and Serverless offerings support only Docker containers. For other requirements, Bare Metal is your go-to.</li>
                </ul>
              </li>
              <li style={{ fontSize: 18, paddingTop: 20 }}>
                <b>Private Cloud</b><br></br>
                ...
                <ul>
                  <li>Hardware Flexibility: Use your own trusted hardware or rent from our partners.</li>
                  <li>RunPod Orchestration: License RunPod as the orchestrating layer, ensuring you get our expertise, security, and performance optimization, all on your own infrastructure.</li>
                </ul>
              </li>
            </ol>
          </Stack>
        ...
        <Typography align="left" mb={4} pt={10} variant="h1" id="compliance-overview">
        ...
        <Typography align="left" fontSize={18}>
          <Stack>
            <ul>
              <li style={{ fontSize: 18 }}>
                <b>Partnered Compliance Management:</b> While RunPod itself does not directly hold certain global certifications, we meticulously select data centers that do, ensuring your data benefits from industry-recognized best practices.
              </li>
              <li style={{ fontSize: 18, paddingTop: 20 }}>
                <b>Transparent Reporting:</b> Transparency is key. We make it clear which certifications our partner data centers hold, allowing you to make informed decisions about where your data resides.
              </li>
            </ul>
          </Stack>
        </Typography>
        ...
        <Typography align="left" fontSize={18}>
          ...
          It&apos;s essential for clients to review the specific certifications of their chosen data center on our platform. This ensures alignment with your compliance needs. Should you require further clarity or detail on any certification or wish to understand the compliance profile of a specific data center, our dedicated compliance team is always here to assist. Please schedule a time to chat with a member of our team <Link target="_blank" href="https://meetings.runpod.io/meetings/runpod/enterprise-compliance-and-security-chat">here</Link>.
        </Typography>



        <Typography align="left" mb={4} pt={10} variant="h1" id="data-center-partners">
        ...
        <Typography align="left" fontSize={18}>
          <Stack>
            <ul>
              <li style={{ fontSize: 18 }}>
                <b>Security:</b> From physical barriers to advanced cybersecurity measures, we ensure that the data center can protect against both physical and digital threats.
              </li>
              <li style={{ fontSize: 18, paddingTop: 20 }}>
                <b>Reliability:</b> We assess the data center&apos;s track record, ensuring it has redundancies in place to offer consistent uptime and can handle both expected and unexpected loads.
              </li>
              <li style={{ fontSize: 18, paddingTop: 20 }}>
                <b>Compliance:</b> Recognizing the importance of regulatory adherence, we prioritize data centers that are certified by globally-recognized standards.
              </li>
              <li style={{ fontSize: 18, paddingTop: 20 }}>
                <b>Environmental Concerns:</b> Sustainability is key. Our partner data centers should exhibit energy-efficient operations, reducing the carbon footprint while maintaining peak performance.
              </li>
              <li style={{ fontSize: 18, paddingTop: 20 }}>
                <b>Innovation and Technology:</b> We look for data centers that invest in cutting-edge technology and constantly evolve to keep up with the changing IT landscape.
              </li>
            </ul>
          </Stack>
        </Typography>
        ...
        <Typography align="left" fontSize={18}>
          <Stack>
            <ul>
              <li style={{ fontSize: 18 }}>
                <i>Where is my data physically stored?</i><br></br> 
              ...
              <li style={{ fontSize: 18, paddingTop: 20 }}>
                <i>How do you ensure data sovereignty compliance?</i><br></br> 
              ...
              <li style={{ fontSize: 18, paddingTop: 20 }}>
                <i>Do you offer compatibility with AWS PrivateLink connect?</i><br></br> 
        ...
        <Typography align="left" fontSize={18}>
          <Stack>
            <ul>
              <li style={{ fontSize: 18 }}>
                <i>How often is my data backed up?</i><br></br> 
              ...
              <li style={{ fontSize: 18, paddingTop: 20 }}>
                <i>In case of a data center failure, how do you ensure my data&apos;s availability?</i><br></br> 
        ...
        <Typography align="left" fontSize={18}>
          <Stack>
            <ul>
              <li style={{ fontSize: 18 }}>
                <i>Can we negotiate terms in the Service Level Agreement (SLA)?</i><br></br> 
              ...
              <li style={{ fontSize: 18, paddingTop: 20 }}>
                <i>What&apos;s your uptime guarantee?</i><br></br> 
              ...
              <li style={{ fontSize: 18, paddingTop: 20 }}>
                <i>In case of a dispute, how is it resolved?</i><br></br> 
              ...
              <li style={{ fontSize: 18, paddingTop: 20 }}>
                <i>How does the reliability, redundancy, and security of Secure Cloud data centers on RunPod compare to other data centers?</i><br></br> 
        ...
        <Typography align="left" fontSize={18}>
          This FAQ section provides a foundational understanding of key concerns. However, we always encourage open dialogue. If you have further questions or require more detailed explanations, please don&apos;t hesitate to schedule a time to chat with our team <Link target="_blank" href="https://meetings.runpod.io/meetings/runpod/enterprise-compliance-and-security-chat">here</Link>.
        </Typography>
      </Stack>
