    ...
    <Stack alignItems={'center'} px={{ xs: 2, md: 0 }} mb={20}>
      ...
      <Stack alignItems={'center'} my={6} mb={8} spacing={3}>
        ...
        <Stack alignItems='start' spacing={4} width={{ xs: '100%', md: 800 }}>
          ...
          <Typography sx={{ fontSize: 16 }} align={'justify'}>
            <strong>Platform-Related Queries:</strong> We prioritize queries
            directly related to our platform&apos;s functionality, billing,
            account issues, and any technical difficulties you face with our
            service.
          </Typography>
