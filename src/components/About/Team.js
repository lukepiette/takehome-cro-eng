...
import { Grid, Stack, IconButton, Typography, Box, Button, useMediaQuery } from '@mui/material';
...
export default function Team() {
    ...
    <>
      ...
      >
        ...
        >
          ...
          <Typography
            sx={{
              ...
              background: 'linear-gradient(119.2deg, rgba(255, 255, 255, 0.4) 32.07%, rgba(145, 78, 255, 0.4) 75.29%), #FFFFFF',
        ...
        >
          ...
          >
            <b>We wear multiple hats.</b> Our sales team is has a strong technical background. Our eng team has an exceptional eye for product. Our datacenter operations team has a strong sales background. Whether you{"’"}re doing engineering, sales, operations, design, or product, you should be comfortable wearing more than one hat at a time.<br /><br />
            <b>We are customer-obsessed.</b> We have over 100,000 developers that rely on us to run their workloads. Many of them use RunPod for their production environments. That{"’"}s a huge responsibility that we don{"’"}t take lightly. We are constantly talking to our customers to understand what we can do to level up our platform.<br /><br />
            <b>We contribute cross-functionally.</b> If you think there{"’"}s a better way of doing X, even if it doesn{"’"}t directly fall under your function, you should voice that to the team. The most important products we{"’"}ve built have stemmed from conversations between non-overlapping teams, like ML + Sales, Customer Support + Product, and Datacenter Operations + Accounting.<br /><br />
            <b>We are agile.</b> At this stage, we need to move quickly. The faster we can ship products that delight our customers, the more successful they will be with our platform. The AI industry is constantly evolving, and we must be able to evolve just as quickly. There are some things we believe won{"’"}t change. Developers will always want faster, more accessible and cost-effective compute. Although our products may change, our mission will stay the same.<br /><br />
            <b>We are looking for people who want to grow as RunPod grows.</b> We currently have 35 full-time people on the team, and we anticipate scaling to several hundred over the coming years. We are looking for people with a bias towards leadership, who can hire and manage talented folks as their function within RunPod scales.<br /><br />
          </Typography>
          <Button
            variant="contained"
  ...
  const ProfileCard = ({ image, name, pronouns, bio, twitter, github, linkedin }) => (
    <Box
      sx={{
        display: 'flex',
        flexDirection: 'column',
