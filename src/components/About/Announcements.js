			...
			<Box
				...
				<Box
					...
					<Typography
						...
						This page is updated manually—for an up to date stream
						of RunPod news, checkout{" "}
						<Link href="https://blog.runpod.io/" target="_blank">
							our blog
						</Link>
						.
					</Typography>
				...
				<Box
					...
					<Box
						...
						<Typography
							...
							RunPod{"'"}s $20MM Milestone: Fueling Our Vision,
							Empowering Our Team
						</Typography>
						<Typography
							sx={{
							...
							Exciting news! RunPod has raised $20MM led by Intel
							Capital and Dell Technologies Capital. This boost
							will further our mission to revolutionize AI/ML
							cloud computing.
						</Typography>
						<Box
							sx={{
							...
							<Box
								sx={{
									...
									height: "20px",
									borderLeft:
										"1px solid rgba(249, 250, 251, 0.48)",
