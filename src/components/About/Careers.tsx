			...
			<Box
				...
				<Box
					...
					<Typography
						...
						All of our roles are either hybrid or remote. Most of
						our team is based in SF and New Jersey. We are currently
						looking to grow our SF team, and have a preference for
						candidates who are enthusiastic about working in-person.
					</Typography>
					<Button
						variant="contained"
						component={Link}
