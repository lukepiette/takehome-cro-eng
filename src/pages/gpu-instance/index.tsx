    ...
    <>
      ...
      <Stack alignItems={"center"} my={6} spacing={3}>
        ...
        >
          ...
          <strong>deep learning</strong>, <strong>machine learning</strong>,{" "}
          <strong>scientific computing</strong>, <strong>ai art</strong>, and{" "}
      ...
      <Stack width={{ xs: "100%", md: "inherit" }}>
        ...
        <Stack alignItems="start" maxWidth={600} mt={3} spacing={3}>
          <Typography sx={{ fontSize: 15 }}>
            We have custom images built with Tensorflow, Pytorch, Jupyter Lab,
            Nvidia drivers, and CUDA pre-installed to help you get started in
            minutes.
          </Typography>
          <Typography sx={{ fontSize: 15 }}>
            If none of our custom images fit your use case, you can deploy any
            public container image from hub.docker.com.
          </Typography>
          <Stack spacing={1}>
            ...
            <Typography sx={{ fontSize: 15 }}>
              As you build your models, you can test with a single GPU and scale
              to production with 8 GPUs seamlessly without losing data.
            </Typography>
          </Stack>
        </Stack>
      </Stack>
  ...
  >
    ...
    >
      <Stack width={{ xs: "100%", md: "inherit" }}>
        ...
        <Stack alignItems="start" maxWidth={600} mt={3} spacing={3}>
          <Typography sx={{ fontSize: 15 }}>
            Pre-installed with TensorFlow, JupyterLab, and other packages to get
            you started quickly.
          </Typography>
          <Stack spacing={1}>
            <Typography sx={{ fontSize: 15 }} fontWeight={600}>
            ...
            <Typography sx={{ fontSize: 15 }}>
              TensorFlow open source platform enables building and training
              machine learning models at production scale. JupyterLab comes
              bundled to help configure and manage TensorFlow models.
            </Typography>
          </Stack>
        </Stack>
      </Stack>
  ...
  >
    ...
    >
      <Stack width={{ xs: "100%", md: "inherit" }}>
        ...
        <Stack alignItems="start" maxWidth={600} mt={3} spacing={3}>
          <Typography sx={{ fontSize: 15 }}>
            Pre-installed with Pytorch, JupyterLab, and other packages to get
            you started quickly.
          </Typography>
          <Stack spacing={1}>
            <Typography sx={{ fontSize: 15 }} fontWeight={600}>
            ...
            <Typography sx={{ fontSize: 15 }}>
              Pytorch open source machine learning platform is another
              alternative to Tensorflow. JupyterLab comes bundled to help
              configure and manage Pytorch models.
            </Typography>
          </Stack>
        </Stack>
      </Stack>
