				...
				<Box sx={{ position: "relative" }}>
					<Hero
						...
						subHeader={
							<Typography
								...
								Teams migrating from Azure to RunPod aren{"'"}t
					...
					<ProblemWithCompetitor
						...
						subHeader={
							<Typography
								...
								<span style={{ color: "#FFFFFF" }}>
									...
									win a Formula 1 race. So why use Azure for
									your AI workloads?{" "}
								</span>
						...
						reasons={[
							...
							"Support that costzs extra but delivers less.",
						...
						subHeader2={
							<Typography
								...
								Azure isn{"'"}t just inefficient for AI—it{"'"}s
					...
					<BenefitsOfRunPod
						...
						subHeader={
							<Typography
								...
								Azure gives you GPUs. RunPod gives you the
