					...
					<Hero
						...
						subHeader={
							<Typography
								...
								Teams migrating from AWS to RunPod aren{"'"}t
					...
					<ProblemWithCompetitor
						...
						subHeader={
							<Typography
								...
								<span style={{ color: "#FFFFFF" }}>
									...
									win a Formula 1 race. So why use AWS for
									your AI workloads?{" "}
								</span>
						...
						subHeader2={
							<Typography
								...
								AWS isn{"'"}t just inefficient for AI—it{"'"}s
								holding you back. It{"'"}s time to evolve.
							</Typography>
						}
					/>
					...
					<BenefitsOfRunPod
						...
						subHeader={
							<Typography
								...
								AWS gives you GPUs. RunPod gives you the future
								of AI infrastructure—at a fraction of the cost.
							</Typography>
						}
						reasons={[
