...
const LlamaPage: NextPage = ({ data = null }: any) => {
  return (
    <>
        <HTMLHead
            title="Run Llama 2 13B With A Custom API endpoint"
            description="In minutes, create a custom API endpoint to host your Llama 2 13B model."
        />
        <main>
            <ModelPage modelName={"Llama 2 13B"} data={data}/>
        </main>
    </>
  );
};
