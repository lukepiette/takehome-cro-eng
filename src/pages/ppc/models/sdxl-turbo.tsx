...
const LlamaPage: NextPage = ({ data = null }: any) => {
  return (
    <>
        <HTMLHead
            title="Run SDXL Turbo With A Custom API endpoint"
            description="In minutes, create a custom API endpoint to host your Stable Diffusion Turbo model."
        />
        <main>
            <ModelPage modelName={"Stable Diffusion Turbo"} data={data}/>
        </main>
    </>
  );
};
