...
const LlamaPage: NextPage = ({ data = null }: any) => {
  return (
    <>
        <HTMLHead
            title="Run FLUX Schnell With A Custom API endpoint"
            description="In minutes, create a custom API endpoint to host your FLUX Schnell model."
        />
        <main>
            <ModelPage modelName={"FLUX schnell"} data={data}/>
        </main>
    </>
  );
};
