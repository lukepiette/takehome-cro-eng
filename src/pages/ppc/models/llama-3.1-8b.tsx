...
const LlamaPage: NextPage = ({ data = null }: any) => {
  return (
    <>
        <HTMLHead
            title="Run Llama 3.1 8B With A Custom API endpoint"
            description="In minutes, create a custom API endpoint to host your Llama 3.1 8B model."
        />
        <main>
            <ModelPage modelName={"Llama 3.1 8B"} data={data}/>
        </main>
    </>
  );
};
