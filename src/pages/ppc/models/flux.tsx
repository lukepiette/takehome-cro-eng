...
const LlamaPage: NextPage = ({ data = null }: any) => {
  return (
    <>
        <HTMLHead
            title="Run FLUX With A Custom API endpoint"
            description="In minutes, create a custom API endpoint to host your FLUX model."
        />
        <main>
            <ModelPage modelName={"FLUX"} data={data}/>
        </main>
    </>
  );
};
