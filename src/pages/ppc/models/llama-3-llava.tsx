...
const LlamaPage: NextPage = ({ data = null }: any) => {
  return (
    <>
        <HTMLHead
            title="Run LLaVA With A Custom API endpoint"
            description="In minutes, create a custom API endpoint to host your LLaVA model."
        />
        <main>
            <ModelPage modelName={"LLaVA"} data={data}/>
        </main>
    </>
  );
};
