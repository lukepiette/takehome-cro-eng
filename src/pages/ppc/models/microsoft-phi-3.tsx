...
const LlamaPage: NextPage = ({ data = null }: any) => {
  return (
    <>
        <HTMLHead
            title="Run Microsoft Phi 3 With A Custom API endpoint"
            description="In minutes, create a custom API endpoint to host your Microsoft Phi 3 model."
        />
        <main>
            <ModelPage modelName={"Microsoft Phi 3"} data={data}/>
        </main>
    </>
  );
};
