...
const LlamaPage: NextPage = ({ data = null }: any) => {
  return (
    <>
        <HTMLHead
            title="Run Mistral 7B With A Custom API endpoint"
            description="In minutes, create a custom API endpoint to host your Mistral 7B model."
        />
        <main>
            <ModelPage modelName={"Mistral 7B"} data={data}/>
        </main>
    </>
  );
};
