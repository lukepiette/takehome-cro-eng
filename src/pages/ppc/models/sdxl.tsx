...
const LlamaPage: NextPage = ({ data = null }: any) => {
  return (
    <>
        <HTMLHead
            title="Run SDXL With A Custom API endpoint"
            description="In minutes, create a custom API endpoint to host your Stable Diffusion XL model."
        />
        <main>
            <ModelPage modelName={"Stable Diffusion XL"} data={data}/>
        </main>
    </>
  );
};
