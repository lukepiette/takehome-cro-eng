...
const LlamaPage: NextPage = ({ data = null }: any) => {
  return (
    <>
        <HTMLHead
            title="Run Llama 3.1 70B With A Custom API endpoint"
            description="In minutes, create a custom API endpoint to host your Llama 3.1 70B model."
        />
        <main>
            <ModelPage modelName={"Llama 3.1 70B"} data={data}/>
        </main>
    </>
  );
};
