...
const LlamaPage: NextPage = ({ data = null }: any) => {
  return (
    <>
        <HTMLHead
            title="Run Mixtral 8x7B With A Custom API endpoint"
            description="In minutes, create a custom API endpoint to host your Mixtral 8x7B model."
        />
        <main>
            <ModelPage modelName={"Mixtral 8x7B"} data={data}/>
        </main>
    </>
  );
};
