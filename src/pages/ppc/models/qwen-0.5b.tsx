...
const LlamaPage: NextPage = ({ data = null }: any) => {
  return (
    <>
        <HTMLHead
            title="Run Qwen 2 0.5B With A Custom API endpoint"
            description="In minutes, create a custom API endpoint to host your Qwen 2 0.5B model."
        />
        <main>
            <ModelPage modelName={"Qwen 2 0.5B"} data={data}/>
        </main>
    </>
  );
};
