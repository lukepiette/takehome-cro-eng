...
const LlamaPage: NextPage = ({ data = null }: any) => {
  return (
    <>
        <HTMLHead
            title="Run Goole Gemma 2 With A Custom API endpoint"
            description="In minutes, create a custom API endpoint to host your Goole Gemma 2 model."
        />
        <main>
            <ModelPage modelName={"Goole Gemma 2"} data={data}/>
        </main>
    </>
  );
};
