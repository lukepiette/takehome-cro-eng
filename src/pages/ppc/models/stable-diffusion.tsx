...
const LlamaPage: NextPage = ({ data = null }: any) => {
  return (
    <>
        <HTMLHead
            title="Run Stable Diffusion With A Custom API endpoint"
            description="In minutes, create a custom API endpoint to host your Stable Diffusion model."
        />
        <main>
            <ModelPage modelName={"Stable Diffusion"} data={data}/>
        </main>
    </>
  );
};
