...
const LlamaPage: NextPage = ({ data = null }: any) => {
  return (
    <>
        <HTMLHead
            title="Run ControlNet With A Custom API endpoint"
            description="In minutes, create a custom API endpoint to host your ControlNet model."
        />
        <main>
            <ModelPage modelName={"ControlNet"} data={data}/>
        </main>
    </>
  );
};
