...
import GpuInfo from "@components/GPU2/GpuData/a6000";
...
const GPUCloud: NextPage<{ gpuData: any; metrics: any; sd: any; whisper: any }> = ({ gpuData, metrics, sd, whisper }) => {
	...
	const gpuSpecData = gpuData?.["NVIDIA RTX A6000"] || {};
    ...
    <Head>
      ...
      <meta name="description" content="Rent high-performance Nvidia RTX A6000 GPUs on-demand. Perfect for running Machine Learning workloads." />
      <meta name="author" content="RunPod" />

      {/* Open Graph Tags */}
      <meta property="og:title" content="Rent Nvidia RTX A6000 GPUs On-Demand" />
      <meta property="og:description" content="Rent high-performance Nvidia RTX A6000 GPUs on-demand. Perfect for running Machine Learning workloads." />
      <meta property="og:type" content="website" />
      <meta property="og:url" content="https://www.runpod.io/gpu/a6000" />
      <meta property="og:image" content="https://www.runpod.io/static/images/gpu/preview/a6000-preview-image.webp" />

      {/* Twitter Card Tags */}
      <meta name="twitter:card" content="summary_large_image" />
      <meta name="twitter:creator" content="@runpod_io" />
      <meta name="twitter:title" content="Rent Nvidia RTX A6000 GPUs On-Demand" />
      <meta name="twitter:description" content="Rent high-performance Nvidia RTX A6000 GPUs on-demand. Perfect for running Machine Learning workloads." />
      <meta name="twitter:image" content="https://www.runpod.io/static/images/gpu/preview/a6000-preview-image.webp" />
    </Head>
